@include('shop.layout.header', ['title' => 'Shop'])
@include('shop.layout.navbar')
@include('shop.layout.search-area')
@include('shop.layout.breadcrumb-section',['description' => 'Fresh and Organic','name' => 'Shop'])
		...
		<div class="container">
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href={{route('product-page')}}><img src="assets/img/products/product-img-4.jpg" alt=""></a>
						</div>
						<h3>Avocado</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href={{route('product-page')}}><img src="assets/img/products/product-img-5.jpg" alt=""></a>
						</div>
						<h3>Green Apple</h3>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href={{route('product-page')}}><img src="assets/img/products/product-img-6.jpg" alt=""></a>
						</div>
						<h3>Strawberry</h3>
