				...
				<div class="col-lg-4">
					<div class="sidebar-section">
						<div class="recent-posts">
							<h4>Recent Posts</h4>
							<ul>
								<li><a href={{route('singleNews-page')}}>You will vainly look for fruit on it in autumn.</a></li>
								<li><a href={{route('singleNews-page')}}>A man's worth has its season, like tomato.</a></li>
								<li><a href={{route('singleNews-page')}}>Good thoughts bear good fresh juicy fruit.</a></li>
								<li><a href={{route('singleNews-page')}}>Fall in love with the fresh orange</a></li>
								<li><a href={{route('singleNews-page')}}>Why the berries always look delecious</a></li>
							</ul>
						</div>
						<div class="archive-posts">
							<h4>Archive Posts</h4>
							<ul>
								<li><a href={{route('singleNews-page')}}>JAN 2019 (5)</a></li>
								<li><a href={{route('singleNews-page')}}>FEB 2019 (3)</a></li>
								<li><a href={{route('singleNews-page')}}>MAY 2019 (4)</a></li>
								<li><a href={{route('singleNews-page')}}>SEP 2019 (4)</a></li>
								<li><a href={{route('singleNews-page')}}>DEC 2019 (3)</a></li>
							</ul>
						</div>
						<div class="tag-section">
							<h4>Tags</h4>
							<ul>
								<li><a href={{route('singleNews-page')}}>Apple</a></li>
								<li><a href={{route('singleNews-page')}}>Strawberry</a></li>
								<li><a href={{route('singleNews-page')}}>BErry</a></li>
								<li><a href={{route('singleNews-page')}}>Orange</a></li>
								<li><a href={{route('singleNews-page')}}>Lemon</a></li>
								<li><a href={{route('singleNews-page')}}>Banana</a></li>
							</ul>
						</div>
					</div>
				</div>
